...
const { log, inquirer, spinner, Package, sleep, exec, formatName, formatClassName, ejs } = require('@fast-learn/utils');
...
async function prepare(options) {
  ...
  fileList = fileList && fileList.filter(file => ['node_modules', '.git', '.DS_Store'].indexOf(file) < 0);
